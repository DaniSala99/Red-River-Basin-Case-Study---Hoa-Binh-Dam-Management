...
opt_inputs.theta(6)=x(6);
opt_inputs.theta(7)=x(7);
opt_inputs.theta(8)=x(8);
opt_inputs.theta(9)=x(9);
opt_inputs.theta(10)=x(10);
opt_inputs.theta(11)=x(11);
opt_inputs.theta(12)=x(12);
opt_inputs.theta(13)=x(13);
